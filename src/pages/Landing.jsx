...
export default function Landing() {
  return (
    <div className="min-h-screen bg-white text-[#111] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/90 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-8">
            <Link to="/about" className="text-gray-500 hover:text-[#111] text-sm font-medium">About</Link>
            <Link to="/contact" className="text-gray-500 hover:text-[#111] text-sm font-medium">Contact</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <motion.p
            ...
            className="mt-6 text-base sm:text-lg text-gray-500 max-w-md mx-auto"
          >
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <span className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-50 rounded-full border border-gray-200 text-gray-600 text-sm">
      ...
      {/* Core Value */}
      <section className="relative py-24 sm:py-32 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#111] mb-8">
              You don't need another workout plan.
              <br />
              <span className="text-gray-400">You need someone watching.</span>
            </h2>
      ...
      {/* Leaderboard */}
      <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center justify-center px-4 sm:px-6 bg-white">
        ...
        <div className="max-w-2xl mx-auto text-center relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#111] mb-4 drop-shadow-sm">
              Prove yourself
            </h2>
      ...
      <footer className="py-8 px-4 sm:px-6 border-t border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-500">GymGraph</span>
          </div>
